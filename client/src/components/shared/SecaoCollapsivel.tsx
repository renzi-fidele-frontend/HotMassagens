...
const SecaoCollapsivel = ({ titulo, onOpenChange, filtros, children }: ISecaoCollapsivel) => {
   return (
      <Collapsible open={filtros.idade} onOpenChange={onOpenChange}>
         <div className="border border-zinc-500 rounded-xl">
            ...
            <CollapsibleTrigger asChild>
               <div className="flex items-center justify-between p-6 pb-4 hover:bg-gray-900 rounded-[inherit] hover:cursor-pointer">
                  ...
                  {filtros.idade ? <ChevronUp /> : <ChevronDown />}
               </div>
            </CollapsibleTrigger>
            {/* Body */}
